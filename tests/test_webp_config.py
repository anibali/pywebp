...
class TestWebPConfig:
    ...
    def test_default_target_size_override(self) -> None:
        config = webp.WebPConfig.new(target_size=1000)
        assert config.target_size == 1000
        del config

    def test_default_lossless(self) -> None:
    ...
    def test_lossless_preset_level(self) -> None:
    ...
    def test_lossless_preset_quality_override(self) -> None:
    ...
    def test_lossy_with_lossless_preset_level(self) -> None:
